...
/**
 * Request para validar la creacion de contactos/intermediarios
...
class StoreContactRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            // Cedula CNSF - formato alfanumerico (opcional por ahora)
            'cnsf_license' => [
                'nullable',
                'string',
                'max:30',
            ...
            // Fecha de vencimiento de cedula (opcional por ahora)
            'license_expiry' => [
                'nullable',
                'date',
            ],

            // Tasa de comision (porcentaje 0-100) (opcional por ahora)
            'commission_rate' => [
                'nullable',
                'numeric',
                'min:0',
            ...
            // Agente padre (opcional por ahora)
            'parent_agent_id' => [
                'nullable',
                'exists:contacts,id',
            ],
