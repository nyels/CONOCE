...
const submit = () => {
    ...
    const url = isEditing.value
        ? route('admin.positions.update', form.id)
    ...
    submitForm({
        ...
        successMessage: isEditing.value ? 'Puesto actualizado exitosamente' : 'Puesto creado exitosamente'
    });
};
            ...
            <div class="page-container">
                ...
                <div class="page-header">
                    <div class="header-content">
                        ...
                        <p class="page-subtitle">Gestiona los puestos de trabajo del personal</p>
                    </div>
            ...
            >
                ...
                <div class="form-group">
                    <label class="toggle-label">
                        ...
                        <span class="toggle-text">Puesto activo</span>
                    </label>
                </div>
            </CrudModal>
</template>
