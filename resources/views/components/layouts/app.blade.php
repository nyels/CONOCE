...
<body class="h-full antialiased">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="py-6">
            ...
            <p class="px-6 mt-8 mb-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Catálogos</p>
            ...
            @can('settings.view')
                <p class="px-6 mt-8 mb-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Administración</p>
